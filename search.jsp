...
<div class="container">
    <div class="jumbotron">
        <div class="container">
            <h1>검색 결과</h1>
            <p>검색 하신 내용에 대한 검색 결과입니다</p>
        </div>
    </div>
</div>
<div class="container">
	<form name="search" action="search.jsp" method="post">
	<input type="text" placeholder="검색" name="search" maxlength="20" style="text-align: left; margin-left: 934; margin-bottom: 10; height: 33 ">
    ...
    <div class="row">
        <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
            ...
            Pattern p = Pattern.compile(request.getParameter("search"));
            
                ArrayList<Bbs> list = bbsDAO.getList();
                for(int i=0; i<list.size(); i++){
                	Matcher m = p.matcher(list.get(i).getBbsTitle());
                	if(m.find()){
            %>
                <tr>
         ...
         <a href="bbs.jsp" class="btn btn-primary pull-arraw-left">목록</a>
